...
export function PricingCardsGrid() {
  ...
  const plans = useMemo<PricingPlan[]>(() => {
    ...
    console.log('loaded', billing.loaded);
    console.log('loadBilling', billing.loadBilling);
    console.log('errors', billing.errors);
    console.log('pricingmodel', billing.pricingModel);
    if (
      !billing.loaded ||
      !billing.loadBilling ||
      billing.errors ||
